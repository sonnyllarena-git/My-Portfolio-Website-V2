...
// returning. Ported verbatim from the Website Portfolio project.
...
// size, for converting a DOM measurement into a given camera's world space.
export function pixelToWorldOnPlane(
  px,
  py,
  canvasWidth,
  canvasHeight,
