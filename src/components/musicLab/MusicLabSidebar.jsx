  ...
  return (
    <>
      ...
      <aside
        className={
          isMobile
            ? 'fixed inset-y-0 left-0 z-50 flex w-64 flex-col gap-4 bg-[#12141a] p-4 text-white'
            : 'flex w-60 shrink-0 flex-col gap-4 border-r border-white/10 bg-[#12141a] p-4 text-white'
        }
      >
