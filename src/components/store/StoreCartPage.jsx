...
function StoreCartPage({ onBack, onSelectProduct }) {
  ...
  return (
    <div className={`shrink-0 flex-1 bg-white p-4 ${STORE_BODY_TEXT}`}>
      <button
        type="button"
        onClick={onBack}
      ...
      <h1 className="mt-3 border-b border-gray-200 pb-3 text-2xl">
        Shopping Cart
      </h1>
          ...
          <div className="divide-y divide-gray-200">
            {lines.map((line) => (
              <div
                ...
                className={`flex gap-4 py-4 ${isMobile ? 'flex-col' : ''}`}
              >
                <img
